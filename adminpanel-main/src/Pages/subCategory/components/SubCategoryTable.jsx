...
export default function SubCategoryTable({ value,subCategoryStaticPath }) {
    const { name, image, category, order, status } = value
    return (
        <>
            <tr className='bg-white  border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600'>
                ...
                <td><img src={subCategoryStaticPath+image} width={40} height={40} alt="" /></td>
